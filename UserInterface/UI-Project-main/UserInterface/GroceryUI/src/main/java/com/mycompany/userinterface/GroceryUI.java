...
public class GroceryUI extends javax.swing.JFrame {
    ...
    private void btnListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListActionPerformed
        ...
        btnSeafood.setVisible(false);
        btnFruit.setVisible(false);
        btnVegetable.setVisible(false);
        btnDairy.setVisible(false);
    ...
    private void showControls(boolean visible){
        lblCategoryName.setVisible(visible);
        lblProduct.setVisible(visible);
        lblPrice.setVisible(visible);
        lblAmount.setVisible(visible);
        lblProductName1.setVisible(visible);
        lblProductName2.setVisible(visible);
        lblProductName3.setVisible(visible);
        lblProductName4.setVisible(visible);
        lblProductName5.setVisible(visible);
        lblProductPrice1.setVisible(visible);
        lblProductPrice2.setVisible(visible);
        lblProductPrice3.setVisible(visible);
        lblProductPrice4.setVisible(visible);
        lblProductPrice5.setVisible(visible);
        fldProductQuantity1.setVisible(visible);
        fldProductQuantity2.setVisible(visible);
        fldProductQuantity3.setVisible(visible);
        fldProductQuantity4.setVisible(visible);
        fldProductQuantity5.setVisible(visible);
